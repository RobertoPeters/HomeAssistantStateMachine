...
{
    private ConcurrentDictionary<int, IAutomationHandler> _handlers = [];
...
public class AutomationServiceMessageHandler
{
    public async Task Handle(Automation automation, AutomationService automationService)
    {
        await automationService.Handle(automation);
    }

    public async Task Handle(VariableService.VariableInfo variableInfo, AutomationService automationService)
    {
        await automationService.Handle([variableInfo]);
    }

    public async Task Handle(List<VariableService.VariableInfo> variableInfos, AutomationService automationService)
    {
        await automationService.Handle(variableInfos);
    }

    public async Task Handle(List<VariableService.VariableValueInfo> variableValueInfos, AutomationService automationService)
    {
